...
function Form(form)
{
    ...
    this.getItems = function ()
    {
        ...
        for (var i = 0; i < len; i++)
        {
            if (obj[elements[i].name] == undefined)
                obj[elements[i].name] = this.getValue(elements[i].name);
        }
        return obj;
    }
                ...
                {console.log('step2')
                    ...
                    {console.log('step3')
                        if (e[i] != undefined)
                        {
                            ...
                            console.log(value.indexOf(';' + e[i].value + ';') );
            ...
            case 'select-multiple':
            {
                ...
                if (len > 0)
                {
                    ...
                    for (var j = 0; j < len; j++)
                    {
                        if (e[j] != undefined)
                        {
                            if (value == e[j].value || _value.indexOf(";" + e[j].value + ";") != -1 || value.indexOf(";" + e[j].innerHTML + ";") != -1) {
                                e[j].selected = true;
                            }
                        }
                    }
