...
$breadGuide = \common\models\Category::catRecursion($categoryInfo['id']);
?>
<div class="container">
    <div class="breadcrumb">
        ...
        <?php
        if ($breadGuide):
            foreach($breadGuide as $value):
            ?>
            》<a href="<?php echo Url::to(['/site/list', 'id' => $value['id']]); ?>"><?=$value['name'];?></a>
            <?php
            endforeach;
        endif;
        ?>
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo $categoryInfo['name']; ?></h3>
            <ul>
                <?php
                foreach (YII::$app->goods->getCategoryByParentid($categoryInfo['id']) as $key => $secondCat) :
                    ?>
                ...
                <div class="goods_block">
                    ...
                    <p class="goods_operate">
                        ...
                        <a class="focus" href="javascript:;" onclick="favorite_add(this, 'home', '<?php echo $info['id']; ?>');">
                            <i class="<?php
                            if (in_array($info['id'], $favoriteArr)) {
                                echo 'focused';
                            }
                            ?>"></i>收藏
                        </a>
