...
<% } %>
            ...
            <script type='text/html' id='specButtonLiTemplate'>
                <li id="specButton<%= item['id'] %>">
                    ...
                    <label class="radio"><img src="<?php echo $themeUrl; ?>/images/icon_del.gif" class="delete" title="删除" onclick="delSpec(<%= item['id'] %>, this);" /></label>
                </li>
            </script>
...
<% } %>
                                ...
                                <script type='text/html' id='verticalRowTemplate'>
                                    <tr class='td_c'>
                                        ...
                                        <td>
                                            ...
                                            <img class="operator" src="<?php echo $themeUrl; ?>/images/icon_desc.gif" onclick="positionDown($(this).parent().parent(), $(this).parent().parent().parent());" alt="向下" />
                                            <img class="operator" src="<?php echo $themeUrl; ?>/images/icon_del.gif" onclick="itemRemove($(this).parent().parent());" alt="删除" />
                                        </td>
                                    </tr>
                                </script>
                            </table>
        ...
        //DOM加载完毕
            $(function()
                    ...
                    var specButtonHtml = template.render('specButtonTemplate', {'templateData':<?php echo json_encode($specData,JSON_UNESCAPED_UNICODE);?>});
                    $('.tab').html(specButtonHtml);
                    //规格水平列表展示
                    var horizontalSpecHtml = template.render('horizontalSpecTemplate', {'templateData':<?php echo json_encode($specData,JSON_UNESCAPED_UNICODE);?>});
                    $('#horizontalBox').html(horizontalSpecHtml);
                    <?php endif;?>

                            //规格垂直列表显示
                    <?php if(isset($goodsSpec)):?>
                    var verticalSpecHtml = template.render('verticalSpecTemplate', {'templateData':<?php echo json_encode($goodsSpec,JSON_UNESCAPED_UNICODE);?>});
        ...
        //添加模型规格
                    function addSpec()
                            {
                            art.dialog.open('<?php echo Url::to(['/goods/select-spec']);?>', {
                            title: '选择规格',
                                    okVal:'保存',
