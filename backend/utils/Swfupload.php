...
class Swfupload {
     ...
     */
    public function __construct($themeUrl, $submit = '') {
        $this->path = $themeUrl . '/libs/swfupload/';
        $this->submit = $submit ? $submit : '/upload/goods-img-upload';
